...
class TemporaryLine {
  ...
  loadTextureCross(color) {
    ...
    createWallOutline(p1, p2, p3, p4) {
      ...
      const outlineMaterial = new THREE.LineBasicMaterial({ color: wallEditor.color });
    
      // const outlineMesh = new THREE.LineSegments(outlineGeometry, outlineMaterial);
      wallEditor.temporaryOutline = new THREE.LineSegments(outlineGeometry, outlineMaterial);
    ...
    createCrissCross(p1, p2, p3, p4) {
      ...
      // const texture = textureLoader.load(`/textures/${wallEditor.color}Cross.jpg`)
      // texture.colorSpace = THREE.SRGBColorSpace
  
      // const colorTexture = textureLoader.load(`/textures/${wallEditor.color}Cross.jpg`)
    ...
    createLinesPattern(p1, p2, p3, p4) {
      ...
      // const texture = textureLoader.load(`/textures/${wallEditor.color}Stripe.jpg`)
      // texture.colorSpace = THREE.SRGBColorSpace
  
      // const colorTexture = textureLoader.load(`/textures/${wallEditor.color}Stripe.jpg`)
      // colorTexture.colorSpace = THREE.SRGBColorSpace
